...
function OrderCanceled() {
	...
	const userId = '14'; // Thay bằng userId thực tế
				  ...
				  orders.map((order) => (
					<div className="card mb-3 order-card" key={order.order_id}>
							...
							<div className="d-flex">
							  ...
							  <div>
								...
								<p className="text-muted mb-1">
								  Phân loại hàng: {order.OrderDetails?.[0]?.variant || 'Không có'}
								</p>
								<p className="mb-0">
					  ...
					  <div className="card-footer bg-white d-flex justify-content-between align-items-center py-3">
						<div>
						  <small className="text-muted">Đã hủy tự động bởi hệ thống</small>
