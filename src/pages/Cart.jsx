...
const Cart = () => {
  ...
  const handleSelectAll = () => {
    ...
    setProducts(
      products.map((product) => ({ ...product, selected: !selectAll }))
    );
  };
  ...
  const total = products.reduce(
    (sum, product) =>
      product.selected ? sum + product.price * product.quantity : sum,
    0
  );
        ...
        <div className="col-md-4">
          <div className="p-3 border rounded">
            ...
            <div className="input-group mb-3">
              ...
              />
              <button onClick={handleApplyVoucher} className="btn btn-danger">
                Áp dụng
              </button>
            </div>
