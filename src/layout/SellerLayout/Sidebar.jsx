...
function Sidebar({ isVisible, sidebarClass }) {
    ...
    const isShopActive = isActive('/seller/shop-info') || isActive('/seller/ratting');
    const isManageActive = isActive('/seller/products') || isActive('/seller/suppliers') || isActive('/seller/vouchers');
    const isOrderActive = isActive('/seller/orders'); 
    const isCustomerCareActive = isActive('/seller/chat') || isActive('/seller/ratings');
	...
	return (
		<div
			...
			style={{
                ...
                left: window.innerWidth >= 992 ? (isVisible ? '0' : '-17rem') : '-17rem', 
                transform: window.innerWidth < 992 ? (isVisible ? 'translateX(0)' : 'translateX(-100%)') : 'none', 
				top: 0,
				bottom: 0,
				overflowY: 'auto',
				zIndex: 1030, 
					...
					<div className='accordion-item border-0 mb-1'>
						<h2 className='accordion-header' style={{ boxShadow: 'none' }}>
							<button
                                ...
                                style={{ backgroundColor: isShopActive ? '#e6f2ff' : 'transparent' }} 
							>
						...
						>
							<div className='accordion-body py-0 ps-5'> {/* Điều chỉnh padding */}
								<ul className='list-group list-group-flush'>
									<li className='list-group-item px-0 py-2'> {/* Điều chỉnh padding */}
										<Link to={'/seller/shop-info'} className={`nav-link ${isActive('/seller/shop-info') ? 'fw-bold text-primary' : ''}`}>
											Thông tin gian hàng
										</Link>
									</li>
									<li className='list-group-item px-0 py-2'>
										<Link to={'/seller/ratting'} className={`nav-link ${isActive('/seller/ratting') ? 'fw-bold text-primary' : ''}`}>
											Trang trí gian hàng
										</Link>
									</li>
								</ul>
					...
					<div className='accordion-item border-0 mb-1' >
						<h2 className='accordion-header' style={{ boxShadow: 'none' }}>
							<button
                                ...
                                style={{ backgroundColor: isManageActive ? '#e6f2ff' : 'transparent' }}
							>
						...
						>
							<div className='accordion-body py-0 ps-5'>
								<ul className='list-group list-group-flush'>
									<li className='list-group-item px-0 py-2'>
										<Link to={'/seller/products'} className={`nav-link ${isActive('/seller/products') ? 'fw-bold text-primary' : ''}`}>
											Sản phẩm
										</Link>
									</li>
									<li className='list-group-item px-0 py-2'>
										<Link to={'/seller/suppliers'} className={`nav-link ${isActive('/seller/suppliers') ? 'fw-bold text-primary' : ''}`}>
											Nhà cung cấp
										</Link>
									</li>
									<li className='list-group-item px-0 py-2'>
										<Link to={'/seller/vouchers'} className={`nav-link ${isActive('/seller/vouchers') ? 'fw-bold text-primary' : ''}`}>
											Khuyến mại
										</Link>
									</li>
								</ul>
					...
					<div className='accordion-item border-0 mb-1' >
						<h2 className='accordion-header' style={{ boxShadow: 'none' }}>
							<button
                                ...
                                style={{ backgroundColor: isOrderActive ? '#e6f2ff' : 'transparent' }}
							>
						...
						>
							<div className='accordion-body py-0 ps-5'>
								<ul className='list-group list-group-flush'>
									<li className='list-group-item px-0 py-2'>
										<Link to={'/seller/orders/new'} className={`nav-link ${isActive('/seller/orders/new') ? 'fw-bold text-primary' : ''}`}>
											Đơn hàng mới
										</Link>
									</li>
                                    <li className='list-group-item px-0 py-2'>
                                        <Link to={'/seller/orders/processing'} className={`nav-link ${isActive('/seller/orders/processing') ? 'fw-bold text-primary' : ''}`}>
                                            Đang xử lý
                                        </Link>
                                    </li>
                                    <li className='list-group-item px-0 py-2'>
                                        <Link to={'/seller/orders/ship'} className={`nav-link ${isActive('/seller/orders/ship') ? 'fw-bold text-primary' : ''}`}>
                                            Đang giao
                                        </Link>
                                    </li>
                                    <li className='list-group-item px-0 py-2'>
                                        <Link to={'/seller/orders/completed'} className={`nav-link ${isActive('/seller/orders/completed') ? 'fw-bold text-primary' : ''}`}>
                                            Hoàn thành
                                        </Link>
                                    </li>
                                    <li className='list-group-item px-0 py-2'>
                                        <Link to={'/seller/orders/cancelled'} className={`nav-link ${isActive('/seller/orders/cancelled') ? 'fw-bold text-primary' : ''}`}>
                                            Đã hủy
                                        </Link>
                                    </li>
								</ul>
					...
					<div className='accordion-item border-0 mb-1' >
						<h2 className='accordion-header' style={{ boxShadow: 'none' }}>
							<button
                                ...
                                style={{ backgroundColor: isCustomerCareActive ? '#e6f2ff' : 'transparent' }}
							>
						...
						>
							<div className='accordion-body py-0 ps-5'>
								<ul className='list-group list-group-flush'>
									<li className='list-group-item px-0 py-2'>
										<Link to={'/seller/chat'} className={`nav-link ${isActive('/seller/chat') ? 'fw-bold text-primary' : ''}`}>
											Tin nhắn
										</Link>
									</li>
									<li className='list-group-item px-0 py-2'>
										<Link to={'/seller/ratings'} className={`nav-link ${isActive('/seller/ratings') ? 'fw-bold text-primary' : ''}`}>
											Quản lý đánh giá
										</Link>
									</li>
								</ul>
