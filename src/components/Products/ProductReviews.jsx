                ...
                {feedbacks.length === 0 ? (
                    ...
                    feedbacks.map((review, index) => (
                        ...
                        <ListGroup.Item key={index} className="mb-3 shadow-sm">
                            <Row>
                                <Col md={1}>
                                    <Image src={review.user.avatar} roundedCircle width={50} height={50} />
                                </Col>
                                <Col md={11}>
                                    ...
                                    {review.media.length > 0 && (
                                        <div className="d-flex mt-2">
                                            {review.media.map((img, imgIdx) => (
                                                <Image key={imgIdx} src={img.media_url} className="me-2" width={60} height={60} />
                                            ))}
                                        </div>
                                    )}
